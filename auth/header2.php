        ...
        <div class="collapse navbar-collapse" id="exCollapsingNavbar">
            ...
            <ul class="nav navbar-nav flex-row justify-content-between mr-auto">
                <li class="dropdown order-1">
                    <a href="login.php"><button type="button" class="btn btn-success dropdown-toggle">الدخول </button></a>
                   
                </li>
                
                      <li class="dropdown order-1">
                          <a href="register.php"><button type="button" class="btn btn-success dropdown-toggle">التسجيل </button></a>
