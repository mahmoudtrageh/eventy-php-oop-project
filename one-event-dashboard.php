...
<?php
    ...
    <div class="container home-stats text-center">
            ...
            $stmtreg = $con->prepare("SELECT follower FROM follow_event WHERE followed_event = '$id'");
                $stmtreg ->execute();
...
?>
                ...
                <?php
                    ...
                    <?php 
                                    ...
                                    $stmt2 = $con->prepare("SELECT status FROM events WHERE id='$id'");
                $stmt2->execute();
                $row = $stmt2->fetch();
            ...
            // register session with username
                 ...
                 <div class="stat st-registered">
                           المسجلين المفعلين
                    <span><a href="one-event-members.php?id=<?php echo $id ?>"><?php echo countItem2('regId',  $id) ?></a></span>
                </div>
                 ...
                 <div class="stat st-registered">
                    ...
                    <span><a href="one-event-members.php?id=<?php echo $id ?>&page=pending"><?php echo countItem4('regId',  'الدفع ضروري', 0) ?></a></span>
                </div>
                ...
                <?php
                                    $query = $con->prepare(" SELECT * FROM replies WHERE reply_event = '$id'");
                    $query->execute();
